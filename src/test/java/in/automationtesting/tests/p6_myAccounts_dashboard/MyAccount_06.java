...
public class MyAccount_06 extends TestBaseRapor {
    ...
    public void myAccountsAddress() {
        ...
        ReusableMethods.clickWithJS(homePage.shippingAddressEdit);
        extentTest.info("shippingAddressEdit clicked.");

        //11) User can Edit Shipping address
        homePage.streetAddressBox.sendKeys("test", Keys.ENTER);
        extentTest.info("streetAddressBox sendKeys test.");

        ReusableMethods.jsExecutorScrool(homePage.saveAddressButton);
        ReusableMethods.clickWithJS(homePage.saveAddressButton);
        extentTest.info("saveAddressButton clicked.");

        assertFalse("Gonderim adresi duzenlenemiyor!!", homePage.streetAddressBox.isSelected());
        extentTest.info("streetAddressBox assertion.");
