...
public class Shop_06 extends TestBaseRapor {
    ...
    public void shopDefaultSortingFunctionality() {
        extentTest = extentReports.createTest("Shop_06", "Shop-Varsayılan Sıralama İşlevselliği.");
        //1) Open the browser
        ...
        extentTest.info("'Sort by price: Low to High' tiklandi.");
